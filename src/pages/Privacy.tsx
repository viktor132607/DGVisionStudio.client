...
export default function Privacy() {
    ...
    const privacyJsonLd = {
        ...
        "@type": "WebPage",
        name: isBg ? "Политика за поверителност" : "Privacy Policy",
        url: "https://dgvisionstudio.com/privacy",
        description: isBg
            ? "Политиката за поверителност на DG Vision Studio относно обработването на информация, контактни данни, права и сигурност."
            : "The DG Vision Studio privacy policy regarding information handling, contact details, rights, and security.",
        isPartOf: {
            "@type": "WebSite",
