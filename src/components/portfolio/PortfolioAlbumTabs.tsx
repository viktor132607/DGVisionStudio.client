    ...
    return (
        <div className="border-b border-neutral-300 bg-neutral-100 dark:border-zinc-700 dark:bg-zinc-900">
            <div className="w-full">
                <div className="flex w-full flex-wrap items-center justify-center gap-2 px-4 py-3 sm:px-6 lg:px-8">
                    {albums.map((album) => {
                        ...
                        return (
                            <button
                                ...
                                className={`inline-flex h-10 items-center justify-center rounded-full border px-4 text-[11px] font-bold uppercase tracking-[0.08em] transition sm:px-5 sm:text-xs ${
                                    active
