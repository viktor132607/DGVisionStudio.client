    ...
    return (
        <footer className="mt-16 border-t border-slate-200 bg-white dark:border-white/10 dark:bg-slate-950">
            <div className="mx-auto w-full max-w-[1700px] px-4 py-10 sm:px-6 sm:py-12 md:px-8 lg:px-10 xl:px-12 2xl:px-16">
                <div className="grid grid-cols-1 gap-10 sm:gap-12 lg:grid-cols-[minmax(0,1.25fr)_minmax(260px,0.8fr)_minmax(260px,0.9fr)] lg:items-start lg:gap-12 xl:gap-16 2xl:gap-24">
                    <div className="w-full max-w-xl">
                        <Link to="/" className="inline-flex items-center">
                            <img
                                src="/images/mainlogo.png"
                                alt="DG Vision Studio"
                                className="h-11 w-auto object-contain sm:h-12 md:h-14 xl:h-16"
                            />
                        </Link>
                    ...
                    <div className="grid grid-cols-1 gap-8 min-[430px]:grid-cols-2 sm:gap-10 lg:grid-cols-2 lg:gap-8 xl:gap-12">
                    ...
                    <div className="min-w-0 lg:justify-self-end lg:text-right">
                        <div className="flex flex-col gap-3 text-sm text-slate-500 dark:text-slate-400 sm:text-[15px] lg:items-end">
                            <a
                                ...
                                className="inline-flex w-fit items-center gap-2 transition hover:text-slate-900 dark:hover:text-white"
                            >
                            ...
                            <a
                                ...
                                className="inline-flex w-fit max-w-full items-center gap-2 transition hover:text-slate-900 dark:hover:text-white"
                            >
                                <Mail size={16} className="shrink-0" />
                                <span className="break-all text-left lg:text-right">
                ...
                <div className="mt-8 border-t border-slate-200 pt-6 text-sm text-slate-500 dark:border-white/10 dark:text-slate-400 sm:mt-10 sm:pt-7 md:text-[15px]">
                    <div className="flex flex-col gap-3 text-center sm:text-left lg:flex-row lg:items-center lg:justify-between lg:text-left">
                        <p>
